...
pub mod reconcile_crafts_reducer;
...
pub use reconcile_crafts_reducer::reconcile_crafts;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::ReconcileCrafts { .. } => "reconcile_crafts",
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            ...
            Reducer::ReconcileCrafts {
                region_id,
                craft_ids,
            } => __sats::bsatn::to_vec(&reconcile_crafts_reducer::ReconcileCraftsArgs {
                region_id: region_id.clone(),
